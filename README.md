...
The project is developed using a structured branching model where each feature is implemented independently.
...
feature/UC3-QuantityModel	Introduction of generic quantity class
feature/UC4-NewUnits	Added more length units
feature/UC5-ConversionLogic	Implemented unit conversion
feature/UC6-Addition	Addition of quantities
feature/UC7-TargetConversion	Addition with result unit
feature/UC8-UnitRefactor	Moved logic into enums
feature/UC9-WeightModule	Introduced weight units
feature/UC10-GenericDesign	Generic quantity implementation
feature/UC11-VolumeModule	Added volume support
...
feature/UC15-LayeredArchitecture	Applied N-Tier structure
...
Create a reusable Quantity class
Use enum for units
...
Add two quantities
Convert before performing operation
...
Provides REST APIs with Spring Boot
